.PHONY: build convert_dfa_regex_to_string create_scanner_dfa clean create_jlalr_dfa

default: build convert_dfa_regex_to_string create_scanner_dfa create_jlalr_dfa
...
create_jlalr_dfa:
	...
	java -cp gen/jlalr.jar jlalr.Jlr1 < gen/joos-jlalr-input-format.cfg > gen/joos-lr1.dfa
